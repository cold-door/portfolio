    ...
    <main className="min-h-screen py-36 text-white sm:py-48">
      <section className="page-shell grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-black sm:text-6xl">Frozen Door</h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            C++、AtCoder、Unity、C#、Web 開発などを学習中です。Frozen Door という名前には、試行錯誤の一つひとつを氷の結晶のように形へ残し、まだ見ぬ扉を開いていくというイメージを込めています。
          </p>
        ...
        <div className="glass-card relative overflow-hidden p-8 lg:p-10">
          ...
          <div className="absolute -right-8 -top-8 size-28 rounded-full border border-blue-300/20" aria-hidden="true" />
